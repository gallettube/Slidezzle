...
import diloshjon.jigsaw.activity.GameActivity;
import diloshjon.jigsaw.util.DensityUtils;
...
public class GameFragment extends Fragment implements View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mCurrBlankPos = findBlankBrick(mCurrStatus, GameActivity.level);
    ...
    private Point findBlankBrick(int[][] status, int level) {
        int blank_brik = 0;
        switch(level){
            case 1:
                blank_brik = GameActivity.BLANK_BRICK_1;
                break;
            case 2:
                blank_brik = GameActivity.BLANK_BRICK_2;
                break;
            case 3:
                blank_brik = GameActivity.BLANK_BRICK_3;
                break;
            case 4:
                blank_brik = GameActivity.BLANK_BRICK_4;
                break;
            case 5:
                blank_brik = GameActivity.BLANK_BRICK_5;
                break;
            case 6:
                blank_brik = GameActivity.BLANK_BRICK_6;
                break;
            case 7:
                blank_brik = GameActivity.BLANK_BRICK_7;
                break;
